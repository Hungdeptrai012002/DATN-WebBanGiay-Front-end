      ...
      <div style={{height: '100%', width: '1270px', margin: '0 auto'}}>
        ...
        <div style={{ display: 'flex', justifyContent: 'center'}}>
          <WrapperLeft>
            ...
            <span style={{fontSize:'16px', marginBottom:'10px', fontWeight:'bold'}}>Phí vận chuyển</span>
            ...
            <WrapperListOrder>
              {order?.orderItems?.map((order) => {
                ...
                <div style={{flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                  ...
                  <span style={{ fontSize: '13px', fontWeight: 400}}>{convertPrice(order?.price * order?.amount)}</span>
                  <DeleteOutlined style={{cursor: 'pointer', fontSize:'14px', color:'red'}} onClick={() => handleDeleteOrder(order?.product)}/>
                </div>
              </WrapperItemOrder>
                )
              })}
            ...
            <div style={{width: '100%'}}>
              ...
              <WrapperInfo>
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                  <span style={{fontSize:'14px', marginBottom:'5px'}}>Tạm tính</span>
                  <span style={{color: '#000', fontSize: '14px', fontWeight: 'bold'}}>{convertPrice(priceMemo)}</span>
                </div>
                <div style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                  <span style={{fontSize:'14px', marginBottom:'5px'}}>Giảm giá</span>
              ...
              <WrapperTotal>
                <span style={{fontSize:'14px', marginBottom:'5px'}}>Tổng tiền</span>
